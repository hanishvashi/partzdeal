                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                        ...
                                        <form class="form-horizontal" action="{{route('admin-cp-create')}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group" id="pa" style="display: none;">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" name="price" id="price" placeholder="Enter Amount " required="" type="number" value="" style="width: 50%; display: inline;"><span style="display: inline; font-size: 16px;" id="pz"> {{$sign->sign}}</span>
                                            </div>
                                          </div>
