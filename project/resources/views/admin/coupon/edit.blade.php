                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                        ...
                                        <form class="form-horizontal" action="{{route('admin-cp-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group" id="pa">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" maxlength="2" name="price" id="price" placeholder="Enter Percentage " required="" type="number" min="1" max="100" value="{{$data->price}}" style="width: 50%; display: inline;"><span style="display: inline; font-size: 16px;" id="pz"> %</span>
                                            </div>
                                          </div>
                                          @endif
                                          @if($data->type == 1)
                                          <div class="form-group" id="pa">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" name="price" id="price" placeholder="Enter Amount " required="" type="number"  min="1" value="{{$data->type == 0 ? $data->price : round(($data->price * $sign->value), 2)}}" style="width: 50%; display: inline;"><span style="display: inline; font-size: 16px;" id="pz"> {{$sign->sign}}</span>
                                            </div>
                                          </div>
                                          @endif
                                          <div class="form-group">
