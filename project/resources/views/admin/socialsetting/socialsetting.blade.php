                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                        ...
                                        {{csrf_field()}}
										  ...
										  <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" name="instagram" id="instagram" placeholder="https://instagram.com/" required="" type="text" value="{{$socialdata->instagram}}">
                                            </div>
                                            <div class="col-sm-3">
                                                <label class="switch">
										  ...
										  <div class="form-group">
                                            <label class="control-label col-sm-3" for="telegram">Telegram *</label>
                                            <div class="col-sm-6">
                                              <input class="form-control" name="telegram" id="telegram" placeholder="https://telegram.com/" required="" type="text" value="{{$socialdata->instagram}}">
                                            </div>
                                            <div class="col-sm-3">
                                                <label class="switch">
                                                  <input type="checkbox" name="tg_status" value="1" {{$socialdata->tg_status==1?"checked":""}}>
                                                  <span class="slider round"></span>
                                                </label>
                                            </div>
                                          </div>
