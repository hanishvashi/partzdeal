                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                        ...
                                        <form class="form-horizontal" action="{{route('admin-prod-update',$prod->id)}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" name="sku" id="product_sku" placeholder="Product SKU" required="" value="{{$prod->sku}}" type="text" >
                                            </div>
                                          </div>
                                  <div class="form-group" style="display:none;">
                                        ...
                                        <div id="fimg2" {!! $prod->product_condition == 0 ? "style='display: none;'":"" !!}>
                                          ...
                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="cat">Main Category*</label>
                                            <div class="col-sm-6">
                                            <select class="form-control" id="cat" name="category_id" required="" >
                                              @foreach($cats as $cat)
                                                  <option value="{{$cat->id}}" <?php if($cat->id==$prod->category_id){ echo 'selected';}?> >{{$cat->cat_name}}</option>
                                              @endforeach
                                              </select>
                                            </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <select class="form-control" id="subcat" name="subcategory_id" required="" >
                                              ...
                                              @foreach($subcats as $cat)
                                                  <option value="{{$cat->id}}" <?php if($cat->id==$prod->subcategory_id){ echo 'selected';}?> >{{$cat->cat_name}}</option>
                                              @endforeach
                                              </select>
                                            </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <select class="form-control" id="brand_id" name="brand_id" required="" >
                                              ...
                                              @foreach($brands as $brnd)
                                                  <option value="{{$brnd->id}}" <?php if($brnd->id==$prod->brand_id){ echo 'selected';}?> >{{$brnd->brand_name}}</option>
                                              @endforeach
                                              </select>
                                            </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <select class="form-control" id="series_id" name="series_id" required="" >
                                              ...
                                              @foreach($allseries as $series)
                                                  <option value="{{$series->id}}" <?php if($series->id==$prod->series_id){ echo 'selected';}?> >{{$series->series_name}}</option>
                                              @endforeach
                                              </select>
                                            </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                             <img id="adminimg" src="{{asset('assets/images/products/'.$prod->photo)}}" alt="" style="width: 400px; height: 300px;">
                                            </div>
                                          </div>
                                          <div class="form-group">
