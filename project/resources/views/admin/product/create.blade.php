...
<div>
    ...
    <ul class="nav nav-tabs" role="tablist">
      <li class="active"><a href="#physical" role="tab" data-toggle="tab"> Product</a>
      </li>
    </ul>
    ...
    <div class="tab-content">
      <div class="tab-pane fade active in" id="physical">
                                        <form class="form-horizontal" action="{{route('admin-prod-store')}}" method="POST" enctype="multipart/form-data" id="form1">
                                          ...
                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="product_sku">Product SKU*</label>
                                            <div class="col-sm-6">
                                              <input class="form-control" name="sku" id="product_sku" placeholder="Product SKU" required="" value="" type="text" >
                                            </div>
                                          </div>
                                  <div class="form-group" style="display: none;">
                                        ...
                                        <div id="fimg2" style="display: none;">
                                          ...
                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="subcat">Sub Category</label>
                                            <div class="col-sm-6">
                                          ...
                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="brand_id">Brand*</label>
                                            <div class="col-sm-6">
                                          ...
                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="series_id">Series*</label>
                                            <div class="col-sm-6">
                                            <select class="form-control" id="series_id" name="series_id" required="" >
                    ...
                    <span class="input-group-addon"><i></i></span>
                            ...
                            <div class="form-group">
                              ...
                              <br>
                                          ...
                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="product_cpprice">Product Current Price* <span>(In {{$sign->name}})</span></label>
                                            <div class="col-sm-6">
                                              <input class="form-control" name="cprice" id="product_cpprice" placeholder="e.g 20" required="" type="text">
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="product_pprice">Product Previous Price* <span>(Optional)</span></label>
                                            <div class="col-sm-6">
                                              <input class="form-control" name="pprice" id="product_pprice" placeholder="e.g 25"  type="text">
                                            </div>
                                          </div>

                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="product_stock">Product Stock* <span>(Leave Empty will Show Always Available)</span></label>
                                            <div class="col-sm-6">
                                              <input class="form-control" name="stock" id="product_stock" placeholder="e.g 15"  type="text">
                                            </div>
                                          </div>
										  <div class="form-group">
                                            <label class="control-label col-sm-4" for="min_qty">Minimum Quantity* <span>(Default 1)</span></label>
                                            <div class="col-sm-6">
                                              <input class="form-control" required name="min_qty" id="min_qty" placeholder="e.g 2" min="1" value="1"  type="number">
                                            </div>
                                          </div>
										<div class="form-group">
...
$(document).ready(function() {
  $('#profile_description').summernote({
    height: 250,
    dialogsInBody: true
  });
});
