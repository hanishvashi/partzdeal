...
<div id="home_products" class="section-padding productDetails-carousel-wrap">
    ...
    <div class="row product_list">
      <div class="col-lg-12">
        <div class="section-title mb-4">
          <h2 class="heading_two">{{$lang->amf}}</h2>
        </div>
      </div>
      <div class="col-lg-12">
        <div class="owl-carousel product_slider slider">
  @foreach($relatedproducts as $fprod)
  @php
  ...
  @endphp
        ...
        <div class="col-lg-6"><button type="button"  data-productid="{{$fprod->id}}" class="btn bg-cart addajaxcart btn160widht mb-2"><i class="fa fa-cart-plus mr-2"></i> Add to cart</button></div>
        <div class="col-lg-6"><button type="button"  data-productid="{{$fprod->id}}" data-productsku="{{$fprod->sku}}" data-productname="{{$fprod->name}}" class="btn bg-cart btn160widht enqbtn mb-3" data-toggle="modal" data-target="#InquiryModal"><i class="fa fa-info"></i> Enquire Now</button></div>
        </div>
